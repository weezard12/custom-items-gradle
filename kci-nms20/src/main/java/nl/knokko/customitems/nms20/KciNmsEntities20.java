...
class KciNmsEntities20 extends KciNmsEntities16Plus {
    ...
    public void causeFakeProjectileDamage(
        ...
        EntityTippedArrow fakeArrow = createFakeArrow(worldHandle, projectilePositionX, projectilePositionY, projectilePositionZ);
    ...
    private static EntityTippedArrow createFakeArrow(Object worldHandle, double x, double y, double z) {
        ...
        throw new IllegalStateException("Can't find EntityTippedArrow constructor for 1.20.x");
    }
    ...
    private static EntityTippedArrow constructArrow(Constructor<?> constructor, Object worldHandle,
        ...
        try {
            ...
            throw new RuntimeException("Failed to construct fake arrow for 1.20.x", failure);
        }
    }
    ...
    private static void setOwner(EntityTippedArrow arrow, Object ownerHandle) {
        try {
            ...
            throw new RuntimeException("Failed to set projectile owner in 1.20.x", failure);
        }
    }
    ...
    private static DamageSource createProjectileDamageSource(Object targetHandle, Object projectileHandle, Object ownerHandle) {
        try {
            ...
            throw new RuntimeException("Failed to create projectile DamageSource for 1.20.x", failure);
        }
    }
    ...
    private static void applyDamage(Object targetHandle, DamageSource damageSource, float damage) {
        try {
            ...
            throw new RuntimeException("Failed to apply damage for 1.20.x", failure);
        }
    }
    ...
    private static Method findDamageSourcesMethod() {
        ...
        if (method == null) {
            throw new IllegalStateException("Can't find DamageSources accessor for 1.20.x");
        }
        return method;
    }
    ...
    private static Method findDamageMethod() {
        ...
        if (method == null) {
            Class<?> livingClass = loadNmsClass("net.minecraft.world.entity.LivingEntity");
            if (livingClass != null) {
                method = findDamageMethodIn(livingClass);
            }
        }
        if (method == null) {
            throw new IllegalStateException("Can't find damage method for 1.20.x");
        }
        return method;
    }
    ...
    private static Method findProjectileDamageMethod(Class<?> sourcesClass, Class<?> projectileClass, Class<?> ownerClass) {
        ...
        throw new IllegalStateException("Can't find projectile DamageSource method for 1.20.x");
    }
    ...
    private static Method findSetOwnerMethod() {
        ...
        throw new IllegalStateException("Can't find projectile owner method for 1.20.x");
    }
